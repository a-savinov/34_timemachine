...
var MOTTO = ['Больше дела – меньше слов.',
             'Делу время, потехе час.',
             'Душу вложишь - все сможешь.',
             'За всякое дело берись умело.',
             'Кончил дело — гуляй смело.'
            ];
var RANDOM_MGG_TIMEOUT = 30000
...
class TimerWidget {
    ...
    mount(rootTag) {
        ...
        this.timerContainer.setAttribute("style", "height: 100px; position: fixed;z-index: 9999; top:25px; right:10px;")
    ...
    function handleIntervalTick() {
        ...
        if (secsLeft === 0) {
            ...
            var random_msg = function () {
                alert(MOTTO[Math.floor(Math.random() * MOTTO.length)]);
            };
            setInterval(random_msg, RANDOM_MGG_TIMEOUT)
        }
